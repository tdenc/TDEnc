...
set DECODE_ERROR5=それでダメなら映像や音声の形式を変えて保存してからもう一度使ってみてね
...
set PREMIUM_START3=YouTubeのパートナープログラムに登録してる？（y/n）
set PREMIUM_START4=（よくわからないならnを選びなさいよね）
set YOUTUBE_ERROR1=パートナープログラムに登録していない場合は動画の長さは15分までよ！
set YOUTUBE_ERROR2=動画を短く分割するかパートナー登録をしなさいよね！
...
set CONFIRM_ACCOUNT4=YouTubeパートナー

...
rem ニコニコ新仕様用（HD）
set /a OUT_HEIGHT_NICO_NEW_HD=%DEFAULT_HEIGHT_NEW_HD% + %DEFAULT_HEIGHT_NEW_HD% %% 2
set /a OUT_WIDTH_TEMP=%DEFAULT_HEIGHT_NEW_HD% * %IN_WIDTH_MOD% / %IN_HEIGHT%
set /a OUT_WIDTH_NICO_NEW_HD=%OUT_WIDTH_TEMP% + %OUT_WIDTH_TEMP% %% 2
rem ニコニコ新仕様用（SD）
set /a OUT_HEIGHT_NICO_NEW_SD=%DEFAULT_HEIGHT_NEW_SD% + %DEFAULT_HEIGHT_NEW_SD% %% 2
set /a OUT_WIDTH_TEMP=%DEFAULT_HEIGHT_NEW_SD% * %IN_WIDTH_MOD% / %IN_HEIGHT%
set /a OUT_WIDTH_NICO_NEW_SD=%OUT_WIDTH_TEMP% + %OUT_WIDTH_TEMP% %% 2
rem Twitter用
